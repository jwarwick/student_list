defmodule StudentListWeb.Router do
  use StudentListWeb, :router

  import StudentListWeb.UserAuth

  @content_security_policy Application.compile_env(:student_list, :content_security_policy)
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: StudentListWeb.Telemetry
    end
  end
